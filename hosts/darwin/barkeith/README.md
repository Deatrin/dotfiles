...
Intel MacBook Pro running macOS with nix-darwin.
...
|---------|-------------|-----------------|
| Homebrew | Package management for GUI apps | [hosts/darwin/barkeith/homebrew.nix](homebrew.nix) |
...
```bash
brew bundle --file=~/.config/dotfiles/hosts/darwin/barkeith/Brewfile
```
...
darwin-rebuild switch --flake .#barkeith --show-trace
```

...
M2 MacBook Air running macOS with nix-darwin.
...
|---------|-------------|-----------------|
| Homebrew | Package management for GUI apps | [hosts/darwin/chetzemoka/homebrew.nix](homebrew.nix) |
...
```bash
brew bundle --file=~/.config/dotfiles/hosts/darwin/chetzemoka/Brewfile
```
...
darwin-rebuild switch --flake .#chetzemoka --show-trace
```

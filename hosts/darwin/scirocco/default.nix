{
  ...
  environment.darwinConfig = "$HOME/src/dotfiles/hosts/darwin/scirocco/default.nix";

  networking.hostName = "scirocco";
  ...
  home-manager.users.deatrin = import ../../../home-manager/darwin/scirocco.nix;

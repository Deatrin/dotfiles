...
M2 MacBook Air running macOS with nix-darwin and opnix secrets management.

## Hardware

- **Platform**: aarch64-darwin (Apple Silicon M2)
- **User**: deatrin
...
| Service | Config |
|---------|--------|
| Homebrew | [hosts/darwin/scirocco/homebrew.nix](homebrew.nix) |
...
| Opnix Secrets | [hosts/darwin/scirocco/secrets.nix](secrets.nix) |
...
nh darwin switch
# or
darwin-rebuild switch --flake .#scirocco
```
...
```bash
nix run nix-darwin --extra-experimental-features 'nix-command flakes' -- switch --flake .#scirocco
```

      ...
      containers.forgejo-server = {
        ...
        containerConfig = {
          ...
          labels = [
            ...
            "homepage.href=https://forgejo.deatrin.dev"
            "homepage.description=Git"
            "traefik.enable=true"
            "traefik.http.routers.forgejo.rule=Host(`forgejo.deatrin.dev`)"
            "traefik.http.routers.forgejo-secure.entrypoints=https"
            "traefik.http.routers.forgejo-secure.rule=Host(`forgejo.deatrin.dev`)"

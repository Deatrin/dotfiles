    ...
    containers.immich-server = {
      ...
      containerConfig = {
        ...
        labels = [
          ...
          "homepage.href=https://immich.deatrin.dev"
          "homepage.description=Photo Management"
          "traefik.enable=true"
          "traefik.http.routers.immich.rule=Host(`immich.deatrin.dev`)"
          "traefik.http.routers.immich-secure.entrypoints=https"
          "traefik.http.routers.immich-secure.rule=Host(`immich.deatrin.dev`)"
